...
function PropertyNotification() {
    return (
        <div>
            ...
            <p className="px-13 text-gray-400 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, set do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
