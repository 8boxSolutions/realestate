...
function PropertyPerformanceReview() {
    return (
        <>
            ...
            {/* Chart */}
            <div className="bg-white w h-100 mx-15 mt-5 rounded-2xl">
                <div className="inline-flex w-full">
                    {/* Left Side */}
                    <div className="relative w-full lg:w-1/5 h-full m-10">
                    ...
                    {/* Right Side */}
                    <div className="relative w-full lg:w-4/5 h-full p-5 m-10">
                        <PropertyChart />
                    </div>
                </div>
            </div>
