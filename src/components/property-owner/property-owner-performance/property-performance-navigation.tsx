            ...
            <div className="inline-flex w-full justify-between items-center px-3 mt-5">
                <div className="inline-flex gap-3">
                    <div className="bg-red-300 w-fit py-3 px-5 rounded-2xl cursor-pointer hover:bg-red-300 hover:text-red-600">
                        <p className="text-sm font-bold text-red-600">Today</p>
                    </div>
                    <div className="w-fit py-3 px-5 rounded-2xl cursor-pointer hover:bg-red-300 hover:text-red-600">
                        <p className="text-sm font-bold text-gray-400">Last Month</p>
                    </div>
                    <div className="w-fit py-3 px-5 rounded-2xl cursor-pointer hover:bg-red-300 hover:text-red-600">
                        <p className="text-sm font-bold text-gray-400">Last 6 Months</p>
                    </div>
                    <div className="w-fit py-3 px-5 rounded-2xl cursor-pointer hover:bg-red-300 hover:text-red-600">
                        <p className="text-sm font-bold text-gray-400">Year</p>
                    </div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="size-8">
