...
const ExteriorAndFrontage: React.FC<uploadSlotProps> = ({ upload }) => {
	return (
		<section className="space-y-5 pt-12">
			<h1 className="text-2xl">Exterior and frontage (house/building façade, lot view)</h1>
...
export default ExteriorAndFrontage;
